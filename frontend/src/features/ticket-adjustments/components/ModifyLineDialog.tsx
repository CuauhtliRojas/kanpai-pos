...
export function ModifyLineDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(0,0,0,0.78)] p-4" onClick={() => { if (!isSaving) onClose(); }} role="dialog" aria-modal="true" aria-labelledby="modify-line-title">
      <form
